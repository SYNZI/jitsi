...
public class JingleIQ extends IQ
{
    ...
    // modify xml handling for Jigasi - ensuring that the generated response
    // xml is identical to what is generated by the browser. This likely doesn't
    // have an impact in the overall negotation, but this eliminates possible
    // differences that could have affected the negotiation.
